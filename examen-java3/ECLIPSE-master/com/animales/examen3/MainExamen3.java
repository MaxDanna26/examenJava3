...
public class MainExamen3 {
    public static void main(String[] args) {
        Colibri colibri1 = new Colibri("Martin", 2, 10, "verde");
        Delfin delfin1 = new Delfin("Clarita", 7, 200, 30);
        Leopardo leopardo1 = new Leopardo("Aron", 4, "Savana", 70);
